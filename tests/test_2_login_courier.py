...
class TestLoginCourier:
    ...
    def test_success_login_сourier(self, login_data, create_courier):
        ...
        assert ApiMessagesResponse.message_success_login in login_request['response.text'] and login_request[
    ...
    def test_unsuccessful_login_сourier_missed_field(self, login_data, create_courier, missed_field_in_body):
        ...
        assert ApiMessagesResponse.message_login_missed_field in login_request['response.text'] and login_request[
    ...
    def test_unsuccessful_login_сourier_wrong_data(self, login_data, create_courier, wrong_data_in_body):
        ...
        assert ApiMessagesResponse.message_login_wrong_data in login_request['response.text'] and login_request[
